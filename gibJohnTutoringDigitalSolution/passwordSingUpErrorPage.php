...
<html lang="en">
    ...
    <body id="page-top" onload="startclock()">
        ...
        <div class="pageSpacer">
            <h2>Error: Password must contain one of the following symbols !"£$%^&*()</h2>
            <h2>Contain one Upper and Lower case letter </h2>
            <h2>Contain one number 0-9</h2>
            <h2>And be at least 8 charicters long </h2>
             <!-- Link that will send user back to Signup page-->
            <a href="singUp.php" class="errorLink"><div class="errorBtn">Return to Sing up</div></a>
            </div>
            </div>

    ...
    <body id="page-top" onload="startclock()">
        ...
        <header class="masthead text-center text-white">
            <div class="masthead-content">
                <div class="container px-5">
                    <h2 class="masthead-heading mb-0">Create a Account</h2>
                </div>
            </div>
            </div>
         ...
         <!-- Sign-up form that will send users data to singUpFunk.php to be processed and checked-->
        <form action="singUpFunk.php" method="POST">
            <div id="signupForm">
                <div class="container">
                    ...
                    <input type="date" placeholder="Enter Last name" name="dateOfBirth" required>     
                    <label for="password"><b>Password</b></label>
                    <input type="password" placeholder="Enter Password" name="password" required>
                    <label for="permissionLevel" id="permissionLevel"><b>Permission Level</b></label>
                    <input type="radio" name="permissionLevel" value="1" required> Teacher<br>
                    <input type="radio" name="permissionLevel" value="0" required> Student<br> 
                    <button type="submit" class="submitBtn">Create a Account</button>
                    <p id="TsandCs">By creating an account you agree to our <a href="TsandCs.php"  style="color:dodgerblue">Terms & Conditions</a>.</p>
                </div>
            </div>
        </form>
        <!-- Footer-->

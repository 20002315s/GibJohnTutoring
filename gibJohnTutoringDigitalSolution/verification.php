...
<html lang="en">
    <head>
        ...
        <h2>Verification</h2>
        <!-- Verification form that will send users data to verificationFunk.php to be processed and checked-->
        <form action="verificationFunk.php" method="POST">
            <div class="formContainer">
                <input type="password" placeholder="Enter Verification code" name="verificationCode" required>

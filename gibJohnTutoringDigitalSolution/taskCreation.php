    ...
    <body id="page-top" onload="startclock()">
        ...
        <header class="masthead text-center text-white">
            <div class="masthead-content">
                <div class="container px-5">
                    <h2 class="masthead-heading mb-0">Add A Task</h2>
                    </div>
                </div>
            </div>
        ...
        <div id="creatTaskHolder">
            <div id="taskCreationBox">
                <!-- form for task creation-->
                <form action="taskCreationFunk.php" method="POST">
                    <div class="container">
                        <input type="text" id="taskCreationHeader" placeholder="Enter Task Header Here" name="taskCreationHeader" required>
                        <textarea id="taskCreationDescription" placeholder="Enter Task Discription Here" name="taskCreationDescription" required></textarea> 
                        <button type="submit" class="submitBtn" id="taskCreationSubmitBtn">Submit Task</button>
                    </div>
                </form>
            </div>
        </div>
